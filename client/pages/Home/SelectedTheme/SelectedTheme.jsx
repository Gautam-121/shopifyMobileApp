        ...
        <div className='theme-main-div'>
            ...
            <div className='left-main-card-div'>
                <div className='theme-name-main-div'>
                    ...
                    <div className='them-name-text'><span>Theme Name</span></div>
            ...
            <div className='side-image-div'>
                <div className='images-grid-div'>
                    <div className='images-row'>
                        <div>                <img src="https://styletribute.com/cdn/shop/products/7d90c442cde121a07a9f4e6356adcd36.jpg?v=1695377771&width=600" className='images' />
                        </div>
                        <div>                <img src="https://styletribute.com/cdn/shop/products/7d90c442cde121a07a9f4e6356adcd36.jpg?v=1695377771&width=600" className='images' />
                        </div>
                    </div>
